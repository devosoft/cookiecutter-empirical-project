...
# -*- coding: utf-8 -*-
#
# cookiecutter-empirical-project documentation build configuration file, created by
...
project = u'Cookiecutter Empirical Project'
...
htmlhelp_basename = 'cookiecutter-empirical-projectdoc'
...
latex_documents = [
    (master_doc, 'cookiecutter-empirical-project.tex',
     u'Cookiecutter Empirical Project Documentation',
...
man_pages = [
    (master_doc, 'cookiecutter-empirical-project',
     u'Cookiecutter Empirical Project Documentation',
     [author], 1)
]
